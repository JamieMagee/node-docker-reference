import { validateDigest } from './digest';
...
describe('digest', () => {
  ...
  it('should validate valid digest with sha384', () => {
    validateDigest(
      'sha384:d3fc7881460b7e22e3d172954463dddd7866d17597e7' +
  ...
  it('should throw error on digest with no algorithm', () => {
    expect(() => validateDigest('d41d8cd98f00b204e9800998ecf8427e')).toThrow(
  ...
  it('should throw error on digest with invalid hex', () => {
    expect(() =>
      validateDigest('sha256:d41d8cd98f00b204e9800m98ecf8427e')
    ).toThrow('invalid digest format');
  });

  it('should throw error on digest with shorted hex', () => {
    expect(() => validateDigest('sha256:abcdef0123456789')).toThrow(
      'invalid digest format'
    );
  });
  ...
  it('should throw error on digest with shorted hex in other algorithm', () => {
    expect(() =>
      validateDigest(
        'sha512:abcdef0123456789abcdef012345' +
  ...
  it('should throw error on digest with unknown algorithm', () => {
    expect(() =>
      validateDigest('foo:d41d8cd98f00b204e9800998ecf8427e')
  ...
  it('should throw error on digest with repeated separator', () => {
    expect(() =>
      validateDigest(
        'sha384__foo+bar:d3fc7881460b7e22e3d172954463dddd7866d175' +
